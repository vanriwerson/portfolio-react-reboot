    ...
    return (
      <section className="home">
        ...
        <aside className="content home-skill-list">
          <h1>
            <img src={toolIcon} alt="Ícone de ferramenta" />
            Actual toolkit
          </h1>
        ...
        <main className="content">
          ...
          <img
            src={profile}
            alt="Desenvolvedor Bruno Riwerson desejando boas-vindas"
          />

          <div className="cta-wrapper">
            <p>
              Meu nome é Bruno, Desenvolvedor Web motivado pela geração de
              soluções práticas e eficazes. Fico muito feliz por seu interesse
              em conhecer um pouco do meu trabalho.
            </p>
            <a
              target="_blank"
