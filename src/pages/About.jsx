    ...
    return(
      <section className="about">
        ...
        <div className="about-content">
          ...
          <p>Possuo uma gama bem vasta de interesses. Estudo música desde os 13 anos de idade e já lecionei violão e guitarra, fui instrumentista e vocalista em diversos projetos e pude aprimorar minha retórica, capacidade de negociação, escuta ativa e empatia, primordiais para o trablho em conjunto. Também já trabalhei como voluntário na Biblioteca Comunitária Oficina do Saber (Salão de Leitura Zélia Gattai), ensinando origami para as crianças e aperfeiçoando minha capacidade de transmitir conhecimento.</p>
